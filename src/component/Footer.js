...
<footer>
        <div>
           <a href="#" class="link"><button id="btn">Back To Top</button></a>
        </div>
        <div class="foot">
            <ul>
                <li><a href="#" id="First">
                ...
                <li><a href="#" id="First">Careers</a></li>
                <li><a href="#" id="First">About Amazon</a></li>
                <li><a href="#" id="First">Investor Relations</a></li>
                <li><a href="#" id="First">Amazon Devices</a></li>
            </ul>
            <ul>
                <li><a href="#">
                    <h3 id="First">Make Money with Us</h3>
                </a></li>
                <li><a href="#" id="First">Sell on Amazon</a></li>
                <li><a href="#" id="First">Sell Your Services on Amazon</a></li>
                <li><a href="#" id="First">Sell on Amazon Business</a></li>
                <li><a href="#" id="First">Sell Your Apps on Amazon</a></li>
                <li><a href="#" id="First">Become an Affiliate</a></li>
                <li><a href="#" id="First">Advertise Your Products</a></li>
                <li><a href="#" id="First">Self-Publish with Us</a></li>
                <li><a href="#" id="First">Become an Amazon Vendor</a></li>
                <li><a href="#" id="First">Sell Your Subscription on Amazon</a></li>
                <li><a href="#" id="First">› See all</a></li>
            </ul>
            <ul>
              <li><a href="#" id="First">
                  <h3> Amazon Payment Products</h3>
              </a></li>
              <li><a href="#" id="First">Amazon Rewards Visa Signature Cards</a></li>
              <li><a href="#" id="First">Amazon.com Store Card</a></li>
              <li><a href="#" id="First">Amazon.com Corporate Credit Line</a></li>
              <li><a href="#" id="First">Shop with Points</a></li>
              <li><a href="#" id="First">Credit Card Marketplace</a></li>
              <li><a href="#" id="First">Reload Your Balance</a></li>
              <li><a href="#" id="First">Amazon Currency Converter</a></li>
          </ul>
          <ul>
            <li><a href="#" id="First">
                <h3>Let Us Help You</h3>
            </a></li>
            <li><a href="#" id="First">Your Account</a></li>
            <li><a href="#" id="First">Your Orders</a></li>
            <li><a href="#" id="First">Shipping Rates & Policies</a></li>
            <li><a href="#" id="First">Amazon Prime</a></li>
            <li><a href="#" id="First">Returns & Replacements</a></li>
            <li><a href="#" id="First">Manage Your Content and Devices</a></li>
            <li><a href="#" id="First">Amazon Assistant</a></li>
            <li><a href="#" id="First">Help</a></li>
        </ul>
            <hr/>
            <div class="img">
            <img src="https://i.ibb.co/ZGXQkcz/logo.png" alt="logo" border="0" id="img"/>
              <a href="#" id="btn2"><button id="btn1">English</button></a>
              <a href="#" id="btn2"><button id="btn1">United States</button></a>
            </div>
        </div>
        <div class="final">
            <ul className="txt">
              ...
              <div className="lower">
              <ul id="lower1">
                <li id="lower2"><a href="#" id="One">Conditions of Use</a></li>
                <li id="lower2"><a href="#" id="One">Privacy Notice</a></li>
                <li id="lower2"><a href="#" id="One">Interest-Based Ads</a></li>
                <li id="lower3">&copy; 1996-2017, Amazon.com, Inc. or its affiliates</li>
              </ul>
              </div>
        </div>
    </footer>
